...
<template>
  <section class="app-header">
      ...
      <el-dropdown>
        <span class="el-dropdown-link">
          <div class="svg-container">
            <font-awesome-icon icon="fa-solid fa-ellipsis-vertical" class="menu-svg" />
          </div>
        </span>
        <template #dropdown>
          <el-dropdown-menu>
            <el-dropdown-item @click="goToHome">Home</el-dropdown-item>
            <el-dropdown-item @click="goToWorkspace">Workspace</el-dropdown-item>
          </el-dropdown-menu>
        </template>
      </el-dropdown>
      <!-- <img src="../svgs/menu.svg" alt="" class="menu-svg"> -->
      <a href="/">
    ...
    <nav class="right-nav">
      ...
      <button>
        <svg width="20" height="24" role="presentation" focusable="false" viewBox="0 0 24 24"
